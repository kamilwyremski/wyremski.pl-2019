              ...
              <p><button onClick={this.openPrivacy} className="link"><FormattedMessage id="privacy_policy"/></button></p>
        		...
        		<div className="footer--top text-center">
        			<div itemScope itemType="http://schema.org/Organization" id="footer--social">
        				...
        				<a href="https://plus.google.com/u/0/102325004299979143485?rel=author" title="My profile on Google Plus" target="_blank" rel="publisher noopener noreferrer" itemProp="sameAs"><i className="icon-gplus-squared"></i></a>
